...
from .passport_spec import PassportPhotoSpecFactory, PassportPhotoSpec
from background_change import RemoveBackground
...
class TransformImageToPassportSpecs:
    def __init__(
        ...
        self.background_changer = RemoveBackground()
    ...
    def change_backgound(
        ...
        image = self.background_changer(image)
